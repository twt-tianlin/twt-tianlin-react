...
import { Descriptions, Button, message, Image } from "antd";
...
export default function ApplierDetail() {
  ...
  return (
    <div>
      <Image
        width={200}
        src={"http://localhost:8080/download/applier/photo?filePath=" + applier.photoPath}
      />
      <Descriptions
        title="详细信息"
        bordered
      ...
      >
        ...
        <Descriptions.Item label="高中阶段任职/工作经历">
          {applier.highSchoolExp}
        </Descriptions.Item>
        <Descriptions.Item label="高中阶段所获荣誉">
          {applier.highSchoolHonour}
        </Descriptions.Item>
        <Descriptions.Item label="T恤尺寸">
          {applier.clothesSize}
        </Descriptions.Item>
        <Descriptions.Item label="兴趣爱好">{applier.hobby}</Descriptions.Item>

  ...
  return (
    <div>
      <Card title="导出" style={{textAlign:'center'}}>
        <Card.Grid style={gridStyle} onClick={()=>window.open("http://8.141.161.245:8080/download/applyInfo")}>
        <Button type="link">导出报名信息</Button></Card.Grid>
        <Card.Grid style={gridStyle} onClick={()=>window.open("http://8.141.161.245:8080/download/confirmInfo")}>
        <Button type="link">导出确认信息</Button></Card.Grid>
        <Card.Grid style={gridStyle} onClick={()=>window.open("http://8.141.161.245:8080/download/attachment")}>

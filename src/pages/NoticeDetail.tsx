    ...
    <div>
      <Card  bordered={true}>
        <Paragraph>
          ...
          <Text>附件  【 <Button type="link" onClick={()=>window.open("http://8.141.161.245:8080/download/notice/attachment?filePath="+notice.filePath)}> {notice.filePath.substring(notice.filePath.lastIndexOf("/")+1)} </Button> 】</Text>
          <br />
